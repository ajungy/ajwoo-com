...
export const apps: App[] = [
  ...
  },
  {
    ...
    detail: [
      { lead: 'Turn a screen recording into an editable video.' },
      ...
      { label: 'Automatic Zooms', body: 'Capture adds editable zooms around clusters of clicks. Review and adjust them before exporting.' },
      ...
      { label: 'Clean Up Your Audio', body: 'Adjust microphone and system-audio levels, reduce noise during pauses, and review suggested silence cuts.' },
      { label: 'Remove Filler Words', body: 'Automatically remove distracting filler words like “um” and “uh” from your recording.' },
      { label: 'Automatic Transcription', body: 'Start on-device transcription when you need an editable transcript. Availability and speed depend on your Mac and language resources.' },
      ...
      'Whether you’re creating product demos, tutorials, educational content, software walkthroughs, presentations, or social videos, Capture brings recording and editing into one app. Processing time depends on the recording and your Mac.',
