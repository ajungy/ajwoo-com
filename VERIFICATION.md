...
| 3 | **`/apps` has no data** | **EMPTY BY DESIGN** | No distributable app exists on ajwoo.com. The page renders its empty state. Cards, badges, grouping and the guarded purchase action are built and dormant. |
